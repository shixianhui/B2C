...
class Ptkj_record_model extends CI_Model {
    ...
    public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
        $ret = array();
        $this->db->select("{$this->_tableName}.*,{$this->_otherTable}.end_time,{$this->_otherTable}.pintuan_people,{$this->_otherTable}.name,{$this->_otherTable}.path,{$this->_otherTable}.cut_total_money,{$this->_otherTable}.cut_times,"
        . "{$this->_otherTable}.high_price");
