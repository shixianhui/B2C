...
class Cart_model extends CI_Model {
    ...
    public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
		$ret = array();
		$this->db->select("{$this->_tableName}.*, {$this->_productTName}.path, {$this->_productTName}.postage_template_id,{$this->_productTName}.title,{$this->_productTName}.market_price, {$this->_productTName}.product_num");
