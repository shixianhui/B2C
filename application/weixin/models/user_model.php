...
class User_model extends CI_Model {
	...
	public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
		$ret = array();
		$this->db->select("{$this->_tableName}.id, {$this->_tableName}.username, {$this->_tableName}.add_time, {$this->_tableName}.nickname, {$this->_tableName}.real_name, ".
		                  "{$this->_tableName}.qq_number, {$this->_tableName}.email, {$this->_usergroupTName}.group_name");
