...
class Ad_model extends CI_Model {
    ...
    public function gets($strWhere = NULL, $limit = NULL, $offset = NULL) {
		$ret = array();
		$this->db->select("{$this->_tableName}.id, {$this->_tableName}.category_id, {$this->_tableName}.ad_type,{$this->_tableName}.path,{$this->_tableName}.content, {$this->_tableName}.width, ".
		                  "{$this->_tableName}.height, {$this->_tableName}.display, {$this->_tableName}.sort, {$this->_adGroupTName}.group_name");
