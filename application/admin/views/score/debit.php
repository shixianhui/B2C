...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>积分扣款</caption>
 	<tbody>
 	<tr>
      <th width="20%">
      <strong>积分类型</strong> <br/>
	  </th>
      <td>
    ...
    <tr>
      <th width="20%"><strong>扣款积分数量</strong> <br/>
	  </th>
      <td>
      <input name="score" id="score" size="10" valid="required|isInt" errmsg="扣款积分数量不能为空!|请输入正确的积分数量!" class="input_blur" type="text">
      <font color="red">注:必须大于零</font>
	</td>
    </tr>
    <tr>
      <th width="20%"><strong>扣款原因</strong> <br/>
	  </th>
      <td>
      <textarea valid="required" errmsg="扣款原因不能为空!" name="cause" id="cause" maxlength="400" rows="4" cols="40"  class="textarea_style" style="width: 50%;" ></textarea>
    </td>
    </tr>
 	<tr>
      <td>
      ...
      <td>
      <input class="button_style" name="dosubmit" value=" 确认扣款 " type="submit" onclick="javascript:if(confirm('你确定要对用户进行扣款吗,请认真核对资料？')){return true}else{return false};" >
	</td>
	</tr>
</tbody>
</table>
