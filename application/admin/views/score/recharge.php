...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>积分充值</caption>
    ...
    <tr>
      <th width="20%"><strong>充值积分数量</strong> <br/>
	  </th>
      <td>
      <input name="score" id="score" size="10" valid="required|isInt" errmsg="充值积分数量不能为空!|请输入正确的积分数量!" class="input_blur" type="text">
