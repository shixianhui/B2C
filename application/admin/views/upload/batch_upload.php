   ...
   <?php if ($attachmentList) { ?>
	<?php foreach ($attachmentList as $value) { ?>
      <tr align="center">		
		...
		<textarea maxlength="400" name="image_alt[]" class="textarea" rows="2" cols="50"><?php echo $value['alt']; ?></textarea>
		</td>
	</tr>
  <?php }} ?>
  </tbody>
	...
	$('#batch_image_upload').uploadify({
		...
		'onUploadSuccess' : function(file, data, response) {
			...
			if (json.success) {
				...
				'      <textarea maxlength="400" name="image_alt[]" class="textarea" rows="2" cols="50"></textarea>'+
				'   </td>'+
				'</tr>';
