...
<ul>
  <li><a href="admincp.php/elephant_log/index/1/0/gold" <?php if ($score_type == 'gold') {echo 'class="selected"';} ?>>金象币</a></li>
  <li><a href="admincp.php/elephant_log/index/1/0/silver" <?php if ($score_type == 'silver') {echo 'class="selected"';} ?>>银象币</a></li>
</ul>
</div>
