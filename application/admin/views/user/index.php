...
<td class="align_c"><?php echo $value['user_type']==1?'商家':'会员'; ?></td>
<td>
姓名：<?php echo $value['real_name']; ?><br/>
昵称：<?php echo $value['nickname']; ?><br/>
手机：<?php echo $value['mobile']; ?><br/>
卡号：<?php echo $value['gold_card_num']; ?><br/>
</td>
<td class="align_c"><?php echo $value['total']; ?></td>
<td class="align_c"><?php echo $value['total_gold']; ?></td>
<td class="align_c"><?php echo $value['total_silver']; ?></td>
...
<td class="align_c"><?php if ($value['presenter_username']) { echo $value['presenter_username']."<br/>[ID:{$value['presenter_id']}]";}else{echo '---';} ?></td>
