...
<tr id="id_<?php echo $subMenu['id']; ?>" onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
 ...
 <td title="<?php echo "静态地址：{$subMenu['html_path']}\n【SEO栏目名称：】".clearstring($subMenu['seo_menu_name'])."\n【关键词：】".clearstring($subMenu['keyword'])."\n【描述：】".clearstring($subMenu['abstract']); ?>">&nbsp;&nbsp;┣<a href="javascript:void(0);"><span class=""><?php echo $subMenu['menu_name']; ?></span></a><?php if ($subMenu['en_menu_name']){ echo '['.$subMenu['en_menu_name'].']';} ?></td>
