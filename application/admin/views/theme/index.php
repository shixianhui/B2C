...
<td class="align_c"><?php echo $value['theme_name']; ?></td>
<td class="align_c"><?php echo $value['alias']; ?></td>
<td class="align_c"><a data-lightbox="image_list_group_<?php echo $key; ?>" data-title="" href="<?php if ($value['path']) {echo $value['path'];}else{echo 'images/admin/no_pic.png';} ?>"><img src="<?php if ($value['path']){echo preg_replace('/\./', '_thumb.', $value['path']);} ?>" onerror="javascript:this.src='images/admin/no_pic.png';" width="20" height="20" /></a></td>
<td class="align_c"><?php echo $value['display']?'启用':'关闭'; ?></td>
