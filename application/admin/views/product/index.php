...
<?php if ($product_type_arr) { ?>
<?php foreach ($product_type_arr as $key=>$value) { ?>
<option value="<?php echo $key; ?>"><?php echo $value; ?></option>
<?php }} ?>
</select>
<select name="divide_user_score">
<option value="">-选择发展会员状态-</option>
<option value="1">参与推广分成</option>
<option value="0">不参与推广分成</option>
</select>
<select name="divide_seller_score">
<option value="">-选择发展商家状态-</option>
<option value="1">参与推广分成</option>
<option value="0">不参与推广分成</option>
</select>
<select name="give_score">
<option value="">-选择送积分状态-</option>
<option value="1">参与送积分</option>
<option value="0">不参与送积分</option>
</select>
<select name="consume_score">
<option value="">-选择抵扣积分状态-</option>
<option value="1">参与抵扣积分</option>
<option value="0">不参与抵扣积分</option>
</select>
<select name="postage_way_id">
...
销售量
<input class="input_blur" name="sales_start" size="4" type="text">
-
<input class="input_blur" name="sales_end" size="4" type="text">
库存
<input class="input_blur" name="stock_start" size="4" type="text">
-
<input class="input_blur" name="stock_end" size="4" type="text">
...
<th width="40">销售量</th>
<th width="40">库存</th>
<th width="60" title="送给消费者的金象积分/银象积分数量">送积分</th>
<th width="60" title="换购此商品所需要的银/金象积分数量">积分换购</th>
<th width="60">发展会员</th>
<th width="60">发展商家</th>
<th width="40">状态</th>
<th width="60">发布时间</th>
...
<?php
    ...
    if ($value['product_type'] == 'a') {
    	$give_score_str = '银';
    } else if ($value['product_type'] == 'b') {
    	$give_score_str = '金';
    } else if ($value['product_type'] == 'c') {
    	$give_score_str = '金';
    }
?>
<?php echo $value['give_score']; ?><span style="color: red;">(<?php echo $give_score_str; ?>)</span>
</td>
<td class="align_c">
<?php echo $value['consume_score']; ?>
</td>
<td class="align_c">
<span style="line-height: 25px;" title="发展会员一级可得到的积分">一级：<?php echo $value['divide_user_score']; ?></span><br/>
<span style="line-height: 25px;" title="发展会员二级可得到的积分">二级：<?php echo $value['divide_user_score_sub']; ?></span>
</td>
<td class="align_c">
<span style="line-height: 25px;" title="发展商家一级可得到的积分">一级：<?php echo $value['divide_seller_score']; ?></span><br/>
<span style="line-height: 25px;" title="发展商家二级可得到的积分">二级：<?php echo $value['divide_seller_score_sub']; ?></span>
</td>
...
<td class="align_c">
    ...
    <a onclick="add_comment(<?php echo $value['id']; ?>)" href="javascript:void(0)">评价</a>
</td>
</tr>
<?php endforeach; ?>
<?php endif; ?>
...
<select onchange="javascript:change_postage_way_id(this);" name="postage_way_id" id="postage_way_id">
<option value="">-请选择快递模板-</option>
<?php if ($postage_way_list) { ?>
<?php foreach ($postage_way_list as $key=>$value) { ?>
<option value="<?php echo $value['id']; ?>"><?php echo $value['title']; ?></option>
