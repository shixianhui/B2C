    ...
    <table class="table_form" cellpadding="0" cellspacing="1">
        ...
        <tbody>
                    ...
                    <select class="input_blur" name="parent_id" id="parent_id">
                        ...
                        <?php if (!empty($item_list)) { ?>
                            ...
                            foreach ($item_list as $key => $value) {
                                ...
                                ?>
                                <option <?php echo $selector; ?> value="<?php echo $value['id']; ?>"><?php echo $value['store_category_name']; ?></option>
                            <?php }} ?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                   <input valid="required" errmsg="分类名称不能为空!" name="store_category_name" id="store_category_name" value="<?php if (!empty($item_info)) { echo $item_info['store_category_name'];} ?>" size="80" type="text">
