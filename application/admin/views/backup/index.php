...
<tr onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background=''">
<td><input  name="ids[]" value="<?php echo $value['table_name']; ?>" type="checkbox"> <?php echo ($key+1); ?></td>
