...
<?php foreach ($adgroupList as $key=>$value): ?>
...
<td><a href="admincp.php/adgroup/save/<?php echo $value['id']; ?>" ><?php echo $value['group_name']; ?></a></td>
<td class="align_c"><a href="admincp.php/ad_group/save/<?php echo $value['id']; ?>">修改</a></td>
</tr>
<?php endforeach; ?>
<?php endif; ?>
</tbody>
