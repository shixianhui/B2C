...
<table class="table_form" cellpadding="0" cellspacing="1">
  <caption>基本信息</caption>
    ...
    <tr>
      ...
      <td>
      <textarea name="icp_code" id="icp_code" rows="4" cols="50"  class="textarea_style" style="width: 80%;" ><?php if($itemInfo){echo $itemInfo['icp_code'];} ?></textarea>
      </td>
	</tr>
	<tr>
      <th width="20%">
	...
	<tr>
      ...
      <input name="cache_time" id="cache_time" value="<?php if($itemInfo){echo $itemInfo['cache_time'];} ?>" size="80" class="input_blur" type="text"> <font color="red">分钟</font>
        ...
        <tr>
      <th width="20%">
      <strong>退货地址信息:</strong> <br/>
	  </th>
      <td>
          <input name="return_address" id="return_address" value="<?php if($itemInfo){echo $itemInfo['return_address'];} ?>" size="80" class="input_blur" type="text">
          <font color="red">格式：哈利波特，15527056820，浙江省杭州市江干区下沙高沙百盛苑2幢1单元</font>
	</td>
	</tr>
        <tr>
      <th width="20%">
      <strong>加盟页面视频代码：</strong> <br/>
	  </th>
      <td>
      <textarea name="video_path" id="site_copyright" rows="4" cols="50"  class="textarea_style" style="width: 80%;" ><?php if($itemInfo){echo $itemInfo['video_path'];} ?></textarea>
	</td>
	</tr>
    <tr>
      <td>&nbsp;</td>
