...
<tr onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
 ...
 <td><a href="#"><span class="">首页</span></a></td>
 <td class="align_c"><?php echo $indexCount; ?>/1</td>
 <td class="align_c">0/0</td>
...
<tr onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
 ...
 <td><a href="#"><span class=""><?php echo $menu['menu_name']; ?></span></a></td>
...
<tr onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
 ...
 <td>&nbsp;&nbsp;|-<a href="#"><span class=""><?php echo $subMenu['menu_name']; ?></span></a></td>
...
<tr onMouseOver="this.style.backgroundColor='#ECF7FE'" onMouseOut="this.style.background='#FFFFFF'">
 ...
 <td>&nbsp;&nbsp;&nbsp;&nbsp;|-<a href="#"><span class=""><?php echo $sSubMenu['menu_name']; ?></span></a></td>
...
function createIndex() {
	$.post("admincp.php/html/createIndex",
			{"id": 1},
			function(res){
				if(res.success){
					alert(res.message);
...
function createMenu(id) {
	$.post("admincp.php/html/createMenu",
		{	"id": id
		},
		function(res){
			if(res.success){
...
function createDetail(menuId, model) {
	$.post("admincp.php/html/createDetail",
		{	"menu_id": menuId
		},
		function(res){
			if(res.success){
