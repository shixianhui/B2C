                   ...
                   <form action="<?php echo getBaseUrl(false,'','user/save_exchange/'.$id.'?order_number='.$this->input->get('order_number'),$client_index)?>" id="jsonForm" name="jsonForm" method="post">
                            <ul class="m_form" >
                                <li class="clearfix">
                                    ...
                                    <input type="hidden"  name="exchange_type" value="3">
                                </li>
                                 <li class="clearfix">
                                    <span><font color="red">*</font>仅退款原因：</span>
                                     <select name="refund_cause"  errmsg="请选择退货退款原因">
                                        <option value="" style="color:#e61d47;">请选择仅退款原因</option>
                                        <option value="少件/空包裹"> 少件/空包裹</option>
                                        <option value="拍错/不想要">拍错/不想要</option>
