    ...
    <div class="member_right">
        <div class="box_shadow clearfix mt20 m_border">
            ...
            <div class="member_tab mt20">
                   <form action="<?php echo getBaseUrl(false,'','user/save_exchange/'.$id.'?order_number='.$this->input->get('order_number'),$client_index)?>" id="jsonForm" name="jsonForm" method="post">
                            <ul class="m_form" >
                                <li class="clearfix">
                                    <span>申请服务：</span>
                                    退货退款
                                ...
                                <li class="clearfix">
                                    <span><font color="red">*</font>退货退款原因：</span>
                                     <select name="refund_cause"  errmsg="请选择退货退款原因">
                                        <option value="" style="color:#e61d47;">请选择退货退款原因</option>
                                ...
                                <li class="clearfix">
                                    <span><font color="red">*</font>退款金额：</span>
                                    <input type="text" name="refund_amount" value="<?php echo $item_info ? $item_info['refund_amount'] : '';?>" valid="required|isMoney" errmsg="退款金额不能为空|退款金额格式错误" class="input_txt mr15" style="width:50px;"> 元
                                    （最多<em style="color:red;">
                                        <?php 
                                        if($order_detail_count == 1){
                                            echo $order_info['total'];
                                        }else{
                                            echo number_format($order_detail['buy_price'],2);
                                        }?>
                                        
                                    </em>元，含运费<em style="color:red;">
                                        
                                        <?php 
                                          if($order_detail_count == 1){
                                                echo $order_info['postage_price'];
                                          }else{
                                                echo '0.00';
                                          }?>
                                 ...
                                 <li class="clearfix">
                                     ...
                                     <textarea cols="36" rows="3" id="content" name="content" valid="required" errmsg="说明不能为空"><?php echo $item_info ? $item_info['content'] : '';?></textarea>
                                </li>
                                <li class="clearfix">
                                    <span>上传凭证图片：</span>
...
<!--                                    <input type="hidden" id="path" name="path"  value="" valid="required" errmsg="凭证图片不能为空" >-->
                                ...
                                <li class="clearfix" style="margin-top:20px;"><span>&nbsp;</span><input type="submit" value="提交审核" style="border:none;" class="btn_r"></li>  
                            </ul>
                    </form>
            </div>
        </div>
